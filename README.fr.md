...
> Version actuelle : **0.2.0**. L’implémentation du protocole est couverte par des tests TLS simulés en local, mais sa compatibilité doit encore être validée sur chaque appareil physique et version d’Android TV.
