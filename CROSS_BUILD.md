...
| Windows x86_64 | `libandroidtvremote-x86_64.win.a` | `androidtvremote-x86_64.dll` + `libandroidtvremote-x86_64.win.dll.a` |
| Windows ARM64 | `libandroidtvremote-arm64.win.a` | `androidtvremote-arm64.dll` + `libandroidtvremote-arm64.win.dll.a` |
...
Les builds DLL génèrent également la bibliothèque d'import GNU/MinGW
`libandroidtvremote-<arch>.win.dll.a`. Son absence fait échouer la compilation.
